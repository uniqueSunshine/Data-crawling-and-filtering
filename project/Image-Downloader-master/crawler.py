...
dcap = dict(DesiredCapabilities.CHROME)  # PHANTOMJS
...
def google_image_url_from_webpage(driver, max_number, quiet=False):
    ...
    while True:
        try:
            ...
            thumb_elements = driver.find_elements(by=By.CLASS_NAME,value="rg_i")
            ...
            show_more = driver.find_elements(by=By.CLASS_NAME,value="mye4qd")
    ...
    image_elements = driver.find_elements(by=By.CLASS_NAME,value="islib")
    image_urls = list()
...
def bing_image_url_from_webpage(driver):
    ...
    while True:
        ...
        image_elements = driver.find_elements(by= By.CLASS_NAME,value="iusc")
        if len(image_elements) > img_count:
            ...
            smb = driver.find_elements(by=By.CLASS_NAME,value="btn_seemore")
...
def baidu_image_url_from_webpage(driver):
    ...
    image_elements = driver.find_elements(by=By.CLASS_NAME,value="imgitem")
...
def baidu_get_image_url_using_api(keywords, max_number=10000, face_only=False,
    ...
    init_json = json.loads(res.text.replace(r"\'", ""), strict=False)  #,encoding="utf-8"
